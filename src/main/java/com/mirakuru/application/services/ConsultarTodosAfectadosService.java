...
@Service
public class ConsultarTodosAfectadosService implements ConsultarTodosAfectadosUseCase {

    private final AfectadoRepository repository;

    public ConsultarTodosAfectadosService(AfectadoRepository repository) {
